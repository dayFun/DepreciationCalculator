...
public abstract class AbstractValidator extends InputVerifier implements KeyListener {
    ...
    /**
     * Changes the message that appears in the popup help tip when a component's data is invalid.
     * Subclasses can use this to provide context sensitive help depending on what the user did
     * wrong.
     * 
     * @param message
     */
